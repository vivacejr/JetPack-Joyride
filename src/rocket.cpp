...
Rocket::Rocket(float x, float y,float z,float w,ll i,color_t color) {
...
bool Rocket::tick() {
    this->position.x += this->speed*this->rotx;
    this->position.y += this->speed*this->roty;
    this->position.z += this->speed*this->rotz;
}

bool Rocket::collision(pt a,pt b,pt c) {
}